...
public:
     ...
     */
    static std::vector<FaceLandmark> pfldToWflw(const std::vector<FaceLandmark>& pfld_landmarks);
     ...
     * @return Vector of landmarks in PFLD format (106 points, with interpolation for missing points)
     * @throws std::invalid_argument if input doesn't have 98 landmarks
     */
    static std::vector<FaceLandmark> wflwToPfld(const std::vector<FaceLandmark>& wflw_landmarks);
     ...
     * @return Vector of 5 key landmarks: [left_eye, right_eye, nose, left_mouth, right_mouth]
     */
    static std::vector<FaceLandmark> extractKeyLandmarks(const std::vector<FaceLandmark>& landmarks, 
    ...
    /**
     * @brief Validate landmark format (check if landmark count matches expected format)
     * 
     ...
     */
    static bool validateLandmarkFormat(const std::vector<FaceLandmark>& landmarks, 
