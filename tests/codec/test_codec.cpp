...
TEST_F(CodecTest, UYVY422Decoder)
{
    ...
    yuvData[0] = 128; yuvData[1] = 100; yuvData[2] = 128; yuvData[3] = 150; // First pair
    yuvData[4] = 128; yuvData[5] = 100; yuvData[6] = 128; yuvData[7] = 150; // Second pair
    // Second line
    yuvData[8] = 128; yuvData[9] = 200; yuvData[10] = 128; yuvData[11] = 250; // Third pair
    yuvData[12] = 128; yuvData[13] = 200; yuvData[14] = 128; yuvData[15] = 250; // Fourth pair
...
TEST_F(CodecTest, YUYV422Decoder)
{
    ...
    yuvData[0] = 100; yuvData[1] = 128; yuvData[2] = 150; yuvData[3] = 128; // First pair
    yuvData[4] = 100; yuvData[5] = 128; yuvData[6] = 150; yuvData[7] = 128; // Second pair
    // Second line
    yuvData[8] = 200; yuvData[9] = 128; yuvData[10] = 250; yuvData[11] = 128; // Third pair
    yuvData[12] = 200; yuvData[13] = 128; yuvData[14] = 250; yuvData[15] = 128; // Fourth pair
